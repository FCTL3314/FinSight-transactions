...
type TransactionUsecase interface {
	...
	Create(authUserId int64, createTransactionRequest *models.CreateTransactionRequest) (*domain.Transaction, error)
	Update(authUserId, id int64, updateTransactionRequest *models.UpdateTransactionRequest) (*domain.Transaction, error)
...
func (wu *transactionUsecase) Create(authUserId int64, createTransactionRequest *models.CreateTransactionRequest) (*domain.Transaction, error) {
...
func (wu *transactionUsecase) Update(authUserId int64, id int64, updateTransactionRequest *models.UpdateTransactionRequest) (*domain.Transaction, error) {
